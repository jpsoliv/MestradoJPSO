...
No primeiro caso os retificadores têm seus componentes ordenados de forma que o controle na comutação dos semicondutores proporciona uma entrada de corrente de forma quase senoidal, provendo um alto fator de potência e, consequentemente, uma boa qualidade de energia. 
