...
A topologia de um conversor com correção de fator de potência é semelhante a um retificador de sistemas com condicionamento de dois estágios. Usualmente esses retificadores tem em seu primeiro estágio a conversão AC-DC da tensão, seguido de um segundo estágio com a regulação dos níveis DC para valores especificados \cite{Kolar2011}. Esse tipo de retificador, por sua simplicidade, possui um baixo fator de potência com alta distorção de corrente. Para contornar este problema, conversores com correção de fator de potência é empregado com sua operação semelhante aos retificadores de dois estágios, porém com o primeiro estágio operando com semicondutores comutados controlados de modo que a corrente de entrada requerida apresente uma forma senoidal \cite{Kolar2011,Barbosa2002}. \todo{falar do pfc boost converter por ser o mais encontrado}
...
\todo{ARRUMAR FIGURAS NO PAINT BOM}
