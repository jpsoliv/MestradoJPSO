...
A caracterização de um sistema passivo dá-se pela ausência de fontes externas de energia para a operação \cite{AN779} ou de um controle ativo para o mecanismo de comutação de dispositivos semicondutores, como transistores ou chaves estáticas. Para essa classe de dispositivos passivos destacam-se os filtros lineares e os retificadores de alto fator de potência sem a presença de comutadores comandados. 
...
\subsubsection{Retificadores com Alto Fator de Potência}
...
\cite{Lobo2005,Gong2003,Kolar2011}
