...
Existem inúmeras topologias de conversores com correção de fator de potência, sendo que os mais utilizados são os conversores do tipo \textit{PFC (Power Factor Correction) boost}.\todo{falar do pfc boost converter por ser o mais encontrado}
