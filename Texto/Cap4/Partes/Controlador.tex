...
\subsection{Tipos de Controle}\label{subsubsec:Tipos de Controle}
...
\subsubsection{Método de Controle de Corrente Senoidal}
...
\end{figure}
\todo[backgroundcolor=blue!25]{Legenda nas Figuras FEITO}