...
A análise do espectro de frequência das tensões mostra que a qualidade de energia é melhorada com a aplicação do filtro, entretanto, devido aos níveis de corrente apresentados nesse período, a operação sem filtro não apresenta distorção suficiente de modo a descumprir a norma aeronáutica de referência. \todo{Falta comentar / referenciar as figuras 83 e 84 no texto}
