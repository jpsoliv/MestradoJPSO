...
O atuador eletrohidrostático é um dispositivo empregado em sistemas de comandos de voo onde atua nas superfícies de controle aerodinâmico de uma aeronave. Os EHAs são compostos por dois principais subsistemas: o subsistema elétrico e o subsistema hidráulico. A porção elétrica é composto por um sistema de conversão e condicionamento da tensão elétrica de modo a energizar um motor que impulsiona a bomba do subsistema hidráulico. Com a pressurização das linhas hidráulicas o sistema fica apto a atuar o deslocamento linear do pistão por meio de sistemas de controle.

A subsistema elétrico tem como principais componentes uma ponte trifásica de diodos, um driver DC para DC, um inversor de frequência e uma máquina síncrona baseada em imãs permanentes \cite{Dinca2014}. A Figura \ref{fig:EHA_elec.png} mostra o diagrama simplifica do subsistema elétrico. Cabe lembrar que outros componentes secundários são empregados no subsistema elétrico com o intuito de prover controle e proteção ao EHA, e que não são mostrados na Figura \ref{fig:EHA_elec.png}.  
...
O modelo empregado do EHA é baseado em resultados experimentais de um dispositivo real. 
...
\begin{figure}[!htb] %
	...
	\caption{corrente controlada EHA}
