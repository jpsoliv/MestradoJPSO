...
#include "c5_APFv1_hardware_build_0.h"
...
static const char * c5_debug_family_names[8] = { "nargin", "nargout", "Posc",
  "q", "V1", "V2", "Ic1", "Ic2" };

/* Function Declarations */
static void initialize_c5_APFv1_hardware_build_0
  (SFc5_APFv1_hardware_build_0InstanceStruct *chartInstance);
static void initialize_params_c5_APFv1_hardware_build_0
  (SFc5_APFv1_hardware_build_0InstanceStruct *chartInstance);
static void enable_c5_APFv1_hardware_build_0
  (SFc5_APFv1_hardware_build_0InstanceStruct *chartInstance);
static void disable_c5_APFv1_hardware_build_0
  (SFc5_APFv1_hardware_build_0InstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_APFv1_hardware_build_0
  (SFc5_APFv1_hardware_build_0InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c5_APFv1_hardware_build_0
  (SFc5_APFv1_hardware_build_0InstanceStruct *chartInstance);
static void set_sim_state_c5_APFv1_hardware_build_0
  (SFc5_APFv1_hardware_build_0InstanceStruct *chartInstance, const mxArray
   *c5_st);
static void finalize_c5_APFv1_hardware_build_0
  (SFc5_APFv1_hardware_build_0InstanceStruct *chartInstance);
static void sf_gateway_c5_APFv1_hardware_build_0
  (SFc5_APFv1_hardware_build_0InstanceStruct *chartInstance);
static void initSimStructsc5_APFv1_hardware_build_0
  (SFc5_APFv1_hardware_build_0InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber, uint32_T c5_instanceNumber);
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData);
static real_T c5_emlrt_marshallIn(SFc5_APFv1_hardware_build_0InstanceStruct
  *chartInstance, const mxArray *c5_Ic2, const char_T *c5_identifier);
static real_T c5_b_emlrt_marshallIn(SFc5_APFv1_hardware_build_0InstanceStruct
...
static real_T c5_mpower(SFc5_APFv1_hardware_build_0InstanceStruct *chartInstance,
  real_T c5_a);
static void c5_eml_scalar_eg(SFc5_APFv1_hardware_build_0InstanceStruct
  *chartInstance);
static const mxArray *c5_b_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static int32_T c5_c_emlrt_marshallIn(SFc5_APFv1_hardware_build_0InstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static uint8_T c5_d_emlrt_marshallIn(SFc5_APFv1_hardware_build_0InstanceStruct
  *chartInstance, const mxArray *c5_b_is_active_c5_APFv1_hardware_build_0, const
  char_T *c5_identifier);
static uint8_T c5_e_emlrt_marshallIn(SFc5_APFv1_hardware_build_0InstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void init_dsm_address_info(SFc5_APFv1_hardware_build_0InstanceStruct
  *chartInstance);
  ...
  (SFc5_APFv1_hardware_build_0InstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_APFv1_hardware_build_0 = 0U;
}
  ...
  (SFc5_APFv1_hardware_build_0InstanceStruct *chartInstance)
{
  ...
  real_T *c5_Ic1;
  real_T *c5_Ic2;
  c5_Ic2 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c5_Ic1 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c5_st = NULL;
  c5_st = NULL;
  c5_y = NULL;
  sf_mex_assign(&c5_y, sf_mex_createcellmatrix(3, 1), false);
  c5_hoistedGlobal = *c5_Ic1;
  c5_u = c5_hoistedGlobal;
  c5_b_y = NULL;
  sf_mex_assign(&c5_b_y, sf_mex_create("y", &c5_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c5_y, 0, c5_b_y);
  c5_b_hoistedGlobal = *c5_Ic2;
  c5_b_u = c5_b_hoistedGlobal;
  c5_c_y = NULL;
  sf_mex_assign(&c5_c_y, sf_mex_create("y", &c5_b_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c5_y, 1, c5_c_y);
  c5_c_hoistedGlobal = chartInstance->c5_is_active_c5_APFv1_hardware_build_0;
   ...
   *c5_st)
{
  ...
  *c5_Ic1 = c5_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 0)),
    "Ic1");
  *c5_Ic2 = c5_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 1)),
    "Ic2");
  chartInstance->c5_is_active_c5_APFv1_hardware_build_0 = c5_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 2)),
     "is_active_c5_APFv1_hardware_build_0");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_APFv1_hardware_build_0(chartInstance);
  ...
  (SFc5_APFv1_hardware_build_0InstanceStruct *chartInstance)
{
  ...
  real_T *c5_b_q;
  real_T *c5_b_Posc;
  c5_b_V2 = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
  c5_b_Ic2 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c5_b_V1 = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
  c5_b_q = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c5_b_Ic1 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c5_b_Posc = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 4U, chartInstance->c5_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c5_b_Posc, 0U);
  chartInstance->c5_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 4U, chartInstance->c5_sfEvent);
  c5_hoistedGlobal = *c5_b_Posc;
  c5_b_hoistedGlobal = *c5_b_q;
  c5_c_hoistedGlobal = *c5_b_V1;
  c5_d_hoistedGlobal = *c5_b_V2;
  c5_Posc = c5_hoistedGlobal;
  c5_q = c5_b_hoistedGlobal;
  c5_V1 = c5_c_hoistedGlobal;
  c5_V2 = c5_d_hoistedGlobal;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_nargout, 1U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c5_Posc, 2U, c5_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c5_q, 3U, c5_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c5_V1, 4U, c5_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c5_V2, 5U, c5_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_Ic1, 6U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_Ic2, 7U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 4);
  c5_B = c5_mpower(chartInstance, c5_V1) + c5_mpower(chartInstance, c5_V2);
  c5_y = c5_B;
  c5_b_y = c5_y;
  c5_c_y = c5_b_y;
  c5_d_y = -1.0 / c5_c_y;
  c5_Ic1 = c5_d_y * (c5_Posc * c5_V1 + c5_q * c5_V2);
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 5);
  c5_b_B = c5_mpower(chartInstance, c5_V1) + c5_mpower(chartInstance, c5_V2);
  c5_e_y = c5_b_B;
  c5_f_y = c5_e_y;
  c5_g_y = c5_f_y;
  c5_h_y = -1.0 / c5_g_y;
  c5_Ic2 = c5_h_y * (c5_Posc * c5_V2 - c5_q * c5_V1);
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, -5);
  ...
  *c5_b_Ic2 = c5_Ic2;
  ...
  _SFD_DATA_RANGE_CHECK(*c5_b_Ic1, 1U);
  _SFD_DATA_RANGE_CHECK(*c5_b_q, 2U);
  _SFD_DATA_RANGE_CHECK(*c5_b_V1, 3U);
  _SFD_DATA_RANGE_CHECK(*c5_b_Ic2, 4U);
  _SFD_DATA_RANGE_CHECK(*c5_b_V2, 5U);
}
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  const mxArray *c5_y = NULL;
  SFc5_APFv1_hardware_build_0InstanceStruct *chartInstance;
  chartInstance = (SFc5_APFv1_hardware_build_0InstanceStruct *)chartInstanceVoid;
  ...
  *chartInstance, const mxArray *c5_Ic2, const char_T *c5_identifier)
{
  ...
  c5_y = c5_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c5_Ic2), &c5_thisId);
  sf_mex_destroy(&c5_Ic2);
  return c5_y;
}
...
static void c5_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData)
{
  const mxArray *c5_Ic2;
  const char_T *c5_identifier;
  emlrtMsgIdentifier c5_thisId;
  real_T c5_y;
  SFc5_APFv1_hardware_build_0InstanceStruct *chartInstance;
  chartInstance = (SFc5_APFv1_hardware_build_0InstanceStruct *)chartInstanceVoid;
  c5_Ic2 = sf_mex_dup(c5_mxArrayInData);
...
const mxArray *sf_c5_APFv1_hardware_build_0_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c5_identifier)
{
  ...
  c5_y = c5_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_APFv1_hardware_build_0), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_APFv1_hardware_build_0);
  return c5_y;
}
...
void sf_c5_APFv1_hardware_build_0_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3588588938U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3709677536U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2697739680U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1805261448U);
}

mxArray *sf_c5_APFv1_hardware_build_0_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("KUljC4mEFMUkSCVUkLUY2F");
...
mxArray *sf_c5_APFv1_hardware_build_0_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c5_APFv1_hardware_build_0_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c5_APFv1_hardware_build_0(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"Ic1\",},{M[1],M[10],T\"Ic2\",},{M[8],M[0],T\"is_active_c5_APFv1_hardware_build_0\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_APFv1_hardware_build_0_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc5_APFv1_hardware_build_0InstanceStruct *)
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_event_thresholds(sfGlobalDebugInstanceStruct,
            ...
            0,
            0);
          _SFD_SET_DATA_PROPS(0,1,1,0,"Posc");
          _SFD_SET_DATA_PROPS(1,2,0,1,"Ic1");
          _SFD_SET_DATA_PROPS(2,1,1,0,"q");
          _SFD_SET_DATA_PROPS(3,1,1,0,"V1");
          _SFD_SET_DATA_PROPS(4,2,0,1,"Ic2");
          _SFD_SET_DATA_PROPS(5,1,1,0,"V2");
...

        {
          ...
          real_T *c5_Ic2;
          real_T *c5_V2;
          c5_V2 = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
          c5_Ic2 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
          c5_V1 = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
          c5_q = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
          c5_Ic1 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          c5_Posc = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, c5_Posc);
          _SFD_SET_DATA_VALUE_PTR(1U, c5_Ic1);
          _SFD_SET_DATA_VALUE_PTR(2U, c5_q);
          _SFD_SET_DATA_VALUE_PTR(3U, c5_V1);
          _SFD_SET_DATA_VALUE_PTR(4U, c5_Ic2);
          _SFD_SET_DATA_VALUE_PTR(5U, c5_V2);
        }
      }
    } else {
...
{
  return "EIs2XQ7mJactDzCvWEJ57D";
}

static void sf_opaque_initialize_c5_APFv1_hardware_build_0(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc5_APFv1_hardware_build_0InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c5_APFv1_hardware_build_0
    ((SFc5_APFv1_hardware_build_0InstanceStruct*) chartInstanceVar);
  initialize_c5_APFv1_hardware_build_0
    ((SFc5_APFv1_hardware_build_0InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_APFv1_hardware_build_0(void *chartInstanceVar)
{
  enable_c5_APFv1_hardware_build_0((SFc5_APFv1_hardware_build_0InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c5_APFv1_hardware_build_0(void *chartInstanceVar)
{
  disable_c5_APFv1_hardware_build_0((SFc5_APFv1_hardware_build_0InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c5_APFv1_hardware_build_0(void *chartInstanceVar)
{
  sf_gateway_c5_APFv1_hardware_build_0
    ((SFc5_APFv1_hardware_build_0InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c5_APFv1_hardware_build_0
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_APFv1_hardware_build_0
    ((SFc5_APFv1_hardware_build_0InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c5_APFv1_hardware_build_0();/* state var info */
...
extern void sf_internal_set_sim_state_c5_APFv1_hardware_build_0(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c5_APFv1_hardware_build_0();/* state var info */
  ...
  set_sim_state_c5_APFv1_hardware_build_0
    ((SFc5_APFv1_hardware_build_0InstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c5_APFv1_hardware_build_0
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c5_APFv1_hardware_build_0(S);
}

static void sf_opaque_set_sim_state_c5_APFv1_hardware_build_0(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c5_APFv1_hardware_build_0(S, st);
}

static void sf_opaque_terminate_c5_APFv1_hardware_build_0(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_APFv1_hardware_build_0InstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c5_APFv1_hardware_build_0
      ((SFc5_APFv1_hardware_build_0InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc5_APFv1_hardware_build_0
    ((SFc5_APFv1_hardware_build_0InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_APFv1_hardware_build_0(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c5_APFv1_hardware_build_0(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3880208581U));
  ssSetChecksum1(S,(741005885U));
  ssSetChecksum2(S,(1541920593U));
  ssSetChecksum3(S,(3763323893U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c5_APFv1_hardware_build_0(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_APFv1_hardware_build_0(SimStruct *S)
{
  SFc5_APFv1_hardware_build_0InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc5_APFv1_hardware_build_0InstanceStruct *)utMalloc(sizeof
    (SFc5_APFv1_hardware_build_0InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc5_APFv1_hardware_build_0InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_APFv1_hardware_build_0;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c5_APFv1_hardware_build_0;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c5_APFv1_hardware_build_0;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c5_APFv1_hardware_build_0;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c5_APFv1_hardware_build_0;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c5_APFv1_hardware_build_0;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c5_APFv1_hardware_build_0;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_APFv1_hardware_build_0;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_APFv1_hardware_build_0;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_APFv1_hardware_build_0;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c5_APFv1_hardware_build_0;
...
void c5_APFv1_hardware_build_0_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_APFv1_hardware_build_0(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_APFv1_hardware_build_0(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_APFv1_hardware_build_0(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_APFv1_hardware_build_0_method_dispatcher.\n"
