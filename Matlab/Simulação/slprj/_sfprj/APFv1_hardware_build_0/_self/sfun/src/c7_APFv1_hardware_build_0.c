...
#include "c7_APFv1_hardware_build_0.h"
...
static const char * c7_debug_family_names[7] = { "nargin", "nargout", "u", "v",
  "w", "x", "y" };

/* Function Declarations */
static void initialize_c7_APFv1_hardware_build_0
  (SFc7_APFv1_hardware_build_0InstanceStruct *chartInstance);
static void initialize_params_c7_APFv1_hardware_build_0
  (SFc7_APFv1_hardware_build_0InstanceStruct *chartInstance);
static void enable_c7_APFv1_hardware_build_0
  (SFc7_APFv1_hardware_build_0InstanceStruct *chartInstance);
static void disable_c7_APFv1_hardware_build_0
  (SFc7_APFv1_hardware_build_0InstanceStruct *chartInstance);
static void c7_update_debugger_state_c7_APFv1_hardware_build_0
  (SFc7_APFv1_hardware_build_0InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c7_APFv1_hardware_build_0
  (SFc7_APFv1_hardware_build_0InstanceStruct *chartInstance);
static void set_sim_state_c7_APFv1_hardware_build_0
  (SFc7_APFv1_hardware_build_0InstanceStruct *chartInstance, const mxArray
   *c7_st);
static void finalize_c7_APFv1_hardware_build_0
  (SFc7_APFv1_hardware_build_0InstanceStruct *chartInstance);
static void sf_gateway_c7_APFv1_hardware_build_0
  (SFc7_APFv1_hardware_build_0InstanceStruct *chartInstance);
static void initSimStructsc7_APFv1_hardware_build_0
  (SFc7_APFv1_hardware_build_0InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c7_machineNumber, uint32_T
  c7_chartNumber, uint32_T c7_instanceNumber);
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData);
static real_T c7_emlrt_marshallIn(SFc7_APFv1_hardware_build_0InstanceStruct
  *chartInstance, const mxArray *c7_y, const char_T *c7_identifier);
static real_T c7_b_emlrt_marshallIn(SFc7_APFv1_hardware_build_0InstanceStruct
...
static const mxArray *c7_b_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static int32_T c7_c_emlrt_marshallIn(SFc7_APFv1_hardware_build_0InstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static uint8_T c7_d_emlrt_marshallIn(SFc7_APFv1_hardware_build_0InstanceStruct
  *chartInstance, const mxArray *c7_b_is_active_c7_APFv1_hardware_build_0, const
  char_T *c7_identifier);
static uint8_T c7_e_emlrt_marshallIn(SFc7_APFv1_hardware_build_0InstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void init_dsm_address_info(SFc7_APFv1_hardware_build_0InstanceStruct
  *chartInstance);
  ...
  (SFc7_APFv1_hardware_build_0InstanceStruct *chartInstance)
{
  ...
  chartInstance->c7_is_active_c7_APFv1_hardware_build_0 = 0U;
}
   ...
   *c7_st)
{
  ...
  *c7_x = c7_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c7_u, 0)),
    "x");
  *c7_y = c7_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c7_u, 1)),
    "y");
  chartInstance->c7_is_active_c7_APFv1_hardware_build_0 = c7_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c7_u, 2)),
     "is_active_c7_APFv1_hardware_build_0");
  sf_mex_destroy(&c7_u);
  c7_update_debugger_state_c7_APFv1_hardware_build_0(chartInstance);
  ...
  (SFc7_APFv1_hardware_build_0InstanceStruct *chartInstance)
{
  ...
  real_T *c7_b_w;
  real_T *c7_b_y;
  c7_b_y = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c7_b_w = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
  c7_b_v = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c7_b_x = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  c7_c_hoistedGlobal = *c7_b_w;
  c7_u = c7_hoistedGlobal;
  c7_v = c7_b_hoistedGlobal;
  c7_w = c7_c_hoistedGlobal;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML(&c7_v, 3U, c7_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c7_w, 4U, c7_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c7_x, 5U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c7_y, 6U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c7_sfEvent, 4);
  c7_x = 0.816496580927726 * ((c7_u - 0.5 * c7_v) - 0.5 * c7_w);
  _SFD_EML_CALL(0U, chartInstance->c7_sfEvent, 5);
  c7_y = 1.4142135623730951 * (0.5 * c7_v - 0.5 * c7_w);
  _SFD_EML_CALL(0U, chartInstance->c7_sfEvent, -5);
  ...
  *c7_b_y = c7_y;
  ...
  _SFD_DATA_RANGE_CHECK(*c7_b_x, 1U);
  _SFD_DATA_RANGE_CHECK(*c7_b_v, 2U);
  _SFD_DATA_RANGE_CHECK(*c7_b_w, 3U);
  _SFD_DATA_RANGE_CHECK(*c7_b_y, 4U);
}
...
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData)
{
  ...
  const mxArray *c7_y = NULL;
  SFc7_APFv1_hardware_build_0InstanceStruct *chartInstance;
  chartInstance = (SFc7_APFv1_hardware_build_0InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c7_APFv1_hardware_build_0_get_eml_resolved_functions_info(void)
{
...
static void c7_info_helper(const mxArray **c7_info)
{
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("sqrt"), "name", "name", 7);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 7);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/sqrt.m"), "context",
                  "context", 8);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("eml_error"), "name", "name", 8);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 8);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_sqrt.m"),
                  "resolved", "resolved", 9);
  sf_mex_addfield(*c7_info, c7_b_emlrt_marshallOut(1286825938U), "fileTimeLo",
                  "fileTimeLo", 9);
  sf_mex_addfield(*c7_info, c7_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 9);
  sf_mex_addfield(*c7_info, c7_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  char_T *c7_identifier)
{
  ...
  c7_y = c7_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c7_b_is_active_c7_APFv1_hardware_build_0), &c7_thisId);
  sf_mex_destroy(&c7_b_is_active_c7_APFv1_hardware_build_0);
  return c7_y;
}
...
void sf_c7_APFv1_hardware_build_0_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2902667980U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1759247212U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(766003538U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3592785586U);
}

mxArray *sf_c7_APFv1_hardware_build_0_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("Cjk2AHDScyDOZrrzymHwhD");
...
mxArray *sf_c7_APFv1_hardware_build_0_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c7_APFv1_hardware_build_0_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c7_APFv1_hardware_build_0(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"x\",},{M[1],M[10],T\"y\",},{M[8],M[0],T\"is_active_c7_APFv1_hardware_build_0\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c7_APFv1_hardware_build_0_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc7_APFv1_hardware_build_0InstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          real_T *c7_y;
          c7_y = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
          c7_w = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
          ...
          _SFD_SET_DATA_VALUE_PTR(3U, c7_w);
          _SFD_SET_DATA_VALUE_PTR(4U, c7_y);
        }
      }
    } else {
...
{
  return "XL6W62BzKBk9trcMwwDSRG";
}

static void sf_opaque_initialize_c7_APFv1_hardware_build_0(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc7_APFv1_hardware_build_0InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c7_APFv1_hardware_build_0
    ((SFc7_APFv1_hardware_build_0InstanceStruct*) chartInstanceVar);
  initialize_c7_APFv1_hardware_build_0
    ((SFc7_APFv1_hardware_build_0InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c7_APFv1_hardware_build_0(void *chartInstanceVar)
{
  enable_c7_APFv1_hardware_build_0((SFc7_APFv1_hardware_build_0InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c7_APFv1_hardware_build_0(void *chartInstanceVar)
{
  disable_c7_APFv1_hardware_build_0((SFc7_APFv1_hardware_build_0InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c7_APFv1_hardware_build_0(void *chartInstanceVar)
{
  sf_gateway_c7_APFv1_hardware_build_0
    ((SFc7_APFv1_hardware_build_0InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c7_APFv1_hardware_build_0
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c7_APFv1_hardware_build_0
    ((SFc7_APFv1_hardware_build_0InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c7_APFv1_hardware_build_0();/* state var info */
...
extern void sf_internal_set_sim_state_c7_APFv1_hardware_build_0(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c7_APFv1_hardware_build_0();/* state var info */
  ...
  set_sim_state_c7_APFv1_hardware_build_0
    ((SFc7_APFv1_hardware_build_0InstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c7_APFv1_hardware_build_0
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c7_APFv1_hardware_build_0(S);
}

static void sf_opaque_set_sim_state_c7_APFv1_hardware_build_0(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c7_APFv1_hardware_build_0(S, st);
}

static void sf_opaque_terminate_c7_APFv1_hardware_build_0(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc7_APFv1_hardware_build_0InstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c7_APFv1_hardware_build_0
      ((SFc7_APFv1_hardware_build_0InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc7_APFv1_hardware_build_0
    ((SFc7_APFv1_hardware_build_0InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c7_APFv1_hardware_build_0(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c7_APFv1_hardware_build_0(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(844072410U));
  ssSetChecksum1(S,(415446532U));
  ssSetChecksum2(S,(2486712201U));
  ssSetChecksum3(S,(1125665720U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c7_APFv1_hardware_build_0(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c7_APFv1_hardware_build_0(SimStruct *S)
{
  SFc7_APFv1_hardware_build_0InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc7_APFv1_hardware_build_0InstanceStruct *)utMalloc(sizeof
    (SFc7_APFv1_hardware_build_0InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc7_APFv1_hardware_build_0InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c7_APFv1_hardware_build_0;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c7_APFv1_hardware_build_0;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c7_APFv1_hardware_build_0;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c7_APFv1_hardware_build_0;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c7_APFv1_hardware_build_0;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c7_APFv1_hardware_build_0;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c7_APFv1_hardware_build_0;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c7_APFv1_hardware_build_0;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c7_APFv1_hardware_build_0;
  chartInstance->chartInfo.mdlStart = mdlStart_c7_APFv1_hardware_build_0;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c7_APFv1_hardware_build_0;
...
void c7_APFv1_hardware_build_0_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c7_APFv1_hardware_build_0(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c7_APFv1_hardware_build_0(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c7_APFv1_hardware_build_0(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c7_APFv1_hardware_build_0_method_dispatcher.\n"
